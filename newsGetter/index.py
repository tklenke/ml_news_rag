...
class Index:
    ...
    def index_document(self, document):
        ...
        #remove body text
        self.documents[document.ID].body = None
    ...
    def search(self, query, search_type='AND', rank=False):
        ...
        #return a array of tuples, where first element is the doc the second is either the rank
        # or None if not ranked
        if rank:
    ...
    def print_index(self):
        # Get the keys sorted by the length in reverse order
        sorted_keys = sorted(self.index.keys(), key=len, reverse=True)
